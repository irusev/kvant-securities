    ...
    window.blogArticles = {
        'video-surveillance-benefits': {
            ...
            content: `
                ...
                <h3>2. Интелигентна видеоаналитика</h3>
                ...
                <p><strong>За консултация и избор на най-подходящата система за видеонаблюдение, свържете се с нас на 0700 12 999 или попълнете нашата контактна форма.</strong></p>
            `
        },
        'security-system-selection': {
            ...
            content: `
                ...
                <p><strong>За професионална консултация и безплатен оглед, свържете се с нас на 0700 12 999.</strong></p>
            `
        },
        'incident-response': {
            category: 'Съвети',
            ...
            content: `
                ...
                <p><strong>За информация за нашите услуги за поддръжка и реакция при инциденти, свържете се с нас на 0700 12 999.</strong></p>
            `
        }
    };
}
